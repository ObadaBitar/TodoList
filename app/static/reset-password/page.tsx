      ...
      <main className="flex justify-center h-screen">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(validateUserInput)} className="space-y-3 px-7 py-3">
            ...
            <Button variant="link" className="p-0 text-1xl" type="submit" ><Link href={"/static/login"}><span className="font-normal">Already have an account ?</span> Log in</Link></Button>
